// Local modified version of nf-core/transdecoder/predict
// Modified to support optional BLAST results input via --retain_blastp_hits flag
...
process TRANSDECODER_PREDICT {
    ...
    def blastp_arg = blastp_hits.exists() ? "--retain_blastp_hits ${blastp_hits}" : ''
    """
